                  ...
                  <template>
                    <el-carousel :interval="4000" type="card" height="200px">
                      <el-carousel-item v-for="item in createProcess.file" :key="item" >
                        <img :src="'http://182.254.148.104:8082/file/download/'+item" preview="1" preview-text=" " style="width:100%">
                      </el-carousel-item>
                    </el-carousel>
                  </template>
                </el-form-item>
                  ...
                  <template>
                    <el-carousel :interval="4000" type="card" height="200px">
                      <el-carousel-item v-for="item in resultProcessed.file" :key="item" >
                        <img :src="'http://182.254.148.104:8082/file/download/'+item" preview="2.1" preview-text=" " style="width:100%">
                      </el-carousel-item>
                    </el-carousel>
                  </template>
                </el-form-item>
                  ...
                  <template>
                    <el-carousel :interval="4000" type="card" height="200px">
                      <el-carousel-item v-for="item in resultInspected.file" :key="item" >
                        <img :src="'http://182.254.148.104:8082/file/download/'+item" preview="2.2" preview-text=" " style="width:100%">
                      </el-carousel-item>
                    </el-carousel>
                  </template>
                </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      queryLoginUser () {
        this.$http.post('http://182.254.148.104:8082/job/user/curlogin', null, {
          headers: {
      ...
      queryMenuJobsCount () {
        for (let i = 0, len = this.jobMenu.length; i < len; i++) {
          this.$http('http://182.254.148.104:8082/job/query/count', {
      ...
      queryJobList () {
        ...
        this.$http({
          url: 'http://182.254.148.104:8082/job/query/' + this.queryJobType,
          params: {
      ...
      queryJobProcessList (jobId) {
        ...
        this.resultInspected = {} // 审核结果
        this.$http({
          url: 'http://182.254.148.104:8082/job/jobprocess/query/list/' + jobId,
          method: 'post',
          headers: {
            'Authorization': this.$store.state.ShiroToken.token
          }
      ...
      updateJobDetail (jobId) {
        ...
        this.$http({
          url: 'http://182.254.148.104:8082/job/query/one',
          method: 'post',
          params: {
            'jobId': jobId
          },
      ...
      submitForm (type) {
        ...
        this.$http({
          url: 'http://182.254.148.104:8082/job/' + processUrlMapping[type],
          method: 'post',
          data: form,
          headers: {
            'Authorization': this.$store.state.ShiroToken.token
      ...
      grabJobs (jobId) {
        ...
        this.$http({
          url: 'http://182.254.148.104:8082/job/grab',
          data: {
      ...
      queryUserList () {
        ...
        this.$http.post('http://182.254.148.104:8082/job/user/list', null, {
          headers: {
            'Authorization': this.$store.state.ShiroToken.token
          }
        }).then(response => {
      ...
      forwardJobs () {
        this.$refs['forwardForm'].validate((valid) => {
          if (valid) {
            ...
            this.$http({
              url: 'http://182.254.148.104:8082/job/forward',
              data: {
                jobsIds: this.selectJobsIds,
      ...
      allocateJobs () {
        this.$refs['allocateForm'].validate((valid) => {
          if (valid) {
            ...
            this.$http({
              url: 'http://182.254.148.104:8082/job/allocate',
              data: {
      ...
      searchJobsAboutMe () {
        ...
        this.$http({
          url: 'http://182.254.148.104:8082/job/query/search',
      ...
      // 查询已设置的自动派单开关时间
      queryJobConfig () {
        let url = 'http://182.254.148.104:8082/job/conf/query'
      ...
      setJobSchedule () {
        this.$refs['jobConfigForm'].validate((valid) => {
          if (valid) {
            let url = 'http://182.254.148.104:8082/job/conf/update'
            let form = {
