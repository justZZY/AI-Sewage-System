  ...
  <div class="app-container">
    ...
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit
      ...
      <el-table-column align="center" label="菜单&权限" width="420">
        <template slot-scope="scope">
<!--          <el-button type="success" icon="plus"  @click="showScope(scope.row.menus)">插槽</el-button>-->
...
<!--            <el-button type="primary" icon="plus" @click="showScope(scope.row.users)">插槽</el-button>-->
...
<script>
  export default {
    ...
    methods: {
      ...
      getAllPermisson () {
        // 查询所有权限
        this.$http.get('http://182.254.148.104:8082/user/listAllPermission').then(data => {
      ...
      getList () {
        ...
        this.$http.get('http://182.254.148.104:8082/user/listRole').then(data => {
      ...
      createRole () {
        ...
        // 添加新角色
        this.api({
          url: 'http://182.254.148.104:8082/user/addRole',
          method: 'post',
          data: this.tempRole
        }).then(() => {
          this.getList()
      ...
      updateRole () {
        ...
        // 修改角色
        this.$http.post('http://182.254.148.104:8082/user/updateRole', {
          data: this.tempRole
        }).then(() => {
          this.getList()
          this.dialogFormVisible = false
      ...
      removeRole ($index) {
        ...
        this.$confirm('确定删除此角色?', '提示', {
          ...
          _vue.api({
            url: 'http://182.254.148.104:8082/user/deleteRole',
            method: 'post',
            data: {
              roleId: role.roleId
            }
