...
public class UserServiceImpl implements UserService {
	...
	public JSONObject updateRole(JSONObject jsonObject) {
		...
		String roleId = jsonObjectData.getString("roleId");
		List<Integer> newPerms = (List<Integer>) jsonObjectData.get("permissions");
		JSONObject roleInfo = userDao.getRoleAllInfo(jsonObjectData);
		//System.out.println(roleInfo);
		Set<Integer> oldPerms = (Set<Integer>) roleInfo.get("permissionIds");
		//修改角色名称
		dealRoleName(jsonObjectData, roleInfo);
		//添加新权限
